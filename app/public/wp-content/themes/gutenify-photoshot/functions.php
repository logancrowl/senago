...
function gutenify_photoshot_admin_scripts() {
	...
	// FontAwesome.
	wp_enqueue_style( 'gutenify-photoshot-admin-style', get_stylesheet_directory_uri() . '/css/admin-style.css', $deps, date( 'Ymd-Gis', filemtime( get_theme_file_path( 'style.css' ) ) ) );
